<page backtop = "10mm" backbottom="10mm" backleft="20mm" backright="20mm">
    ...
    <thead>
        <tr>
            ...
            <th style="width: 15%; text-align: left; border: solid 1px #900C3F; background: #900C3F; text-color: #FFFFFF;"><span style = "color: #FFFFFF;">NOMBRE</span></th>
            <th style="width: 15%; text-align: left; border: solid 1px #900C3F; background: #900C3F; text-color: #FFFFFF;"><span style = "color: #FFFFFF;">APELLIDO</span></th>
        </tr>
    </thead>
<tbody>
    <?php
